...
from schemas import schemafactinternetsalesreason
...
if __name__ == '__main__':
    ...
    spark = SparkSession \
            .builder \
            .appName("factinternetsalesreason-stream") \
    ...
    schema = schemafactinternetsalesreason
    
    origin_folder = "s3a://landing/example/dw-files/internetsalesreason"

    destination_topic = "factinternetsalesreason_spark_stream_dwfiles"
