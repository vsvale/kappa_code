...
if __name__ == '__main__':
    ...
    spark = SparkSession \
            .builder \
            .appName("dimproductsubcategory-stream") \
    ...
    origin_folder = "s3a://landing/example/dw-files/productsubcategory"
    ...
    write_into_topic = landing_table \
        .selectExpr("CAST(trim(ProductSubcategoryKey) AS STRING) AS key", "to_json(struct(*)) AS value") \
        .writeStream \
        .format("kafka") \
