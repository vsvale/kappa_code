...
if __name__ == '__main__':
    ...
    origin_folder = "s3a://landing/example/dw-files/date"

    destination_topic = "dimdate_spark_stream_dwfiles"
    ...
    write_into_topic = landing_table \
        .selectExpr("CAST(trim(DateKey) AS STRING) AS key", "to_json(struct(*)) AS value") \
        .writeStream \
        .format("kafka") \
